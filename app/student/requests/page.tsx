    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success("Leave application submitted successfully!", {
                description: "Your request has been forwarded to the HOD for approval."
            });
            ...
            <div className="max-w-4xl mx-auto py-8 space-y-12 transition-all duration-700 animate-in fade-in slide-in-from-bottom-4">
                ...
                <section className="space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-black text-[#1E293B] dark:text-white tracking-tight italic">New Leave Letter</h2>
                    </div>
                        ...
                        <CardContent className="p-12 space-y-10">
                            ...
                            <div className="flex justify-between items-start border-b border-slate-100 dark:border-slate-800 pb-8">
                                <div className="space-y-1">
                                    <p className="text-[10px] font-black text-purple-600 dark:text-purple-400 uppercase tracking-widest">Formal Letter</p>
                                    <h3 className="text-3xl font-black text-[#1E293B] dark:text-white tracking-tight">Leave Letter</h3>
                                </div>
                                <div className="text-right space-y-1">
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Date</p>
                                    <p className="text-sm font-black text-[#1E293B] dark:text-white">{new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-800 dark:text-slate-300 uppercase tracking-widest pl-1">Reason for Leave</label>
                                    <Textarea
                            ...
                            <div className="flex items-center justify-between pt-4">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic max-w-xs">
                                    Your letter will be submitted directly to Professor James for approval.
                                </p>
                                <Button
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            Submit Letter <Send className="w-4 h-4" />
                                        </>
                                    )}
                                </Button>
                            </div>
                ...
                <section className="space-y-6">
                    <div className="flex items-center gap-3">
                        <div className="w-1.5 h-6 bg-gradient-to-b from-purple-600 via-purple-500 to-pink-500 rounded-full" />
                        <h2 className="text-2xl font-black text-[#1E293B] dark:text-white tracking-tight italic">Letter History</h2>
                    </div>
