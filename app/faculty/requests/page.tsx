...
export default function FacultyRequestsHub() {
    ...
    const handleAction = (id: number, action: 'Approved' | 'Rejected') => {
        ...
        toast.success(`Request ${action}`, {
            description: `Student will be notified immediately.`,
        });
    };
            ...
            <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-700 font-sans">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h1 className="text-4xl font-black text-[#1E293B] dark:text-white tracking-tight italic">Requests Hub</h1>
                            <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Manage student and faculty leave permissions</p>
                        </div>
                    </div>
                </div>
