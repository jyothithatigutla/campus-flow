    ...
    return (
        <DashboardLayout>
            <div className="max-w-4xl mx-auto py-8 space-y-8 transition-all duration-500 animate-in fade-in slide-in-from-bottom-4">
                <h1 className="text-3xl font-bold text-purple-900 font-heading">Faculty Settings</h1>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input defaultValue="Faculty Member" className="rounded-xl" />
                                </div>
                                <div className="space-y-2">
                                    <Label>Faculty ID</Label>
                                    <Input defaultValue="FAC20210001" disabled className="rounded-xl opacity-70" />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm text-muted-foreground">Receive updates about student requests</p>
                                </div>
